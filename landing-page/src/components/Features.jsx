...
const Features = () => {
  return (
    <div id="Features" className=" scroll-mt-24 relative mt-20  border-neutral-800 min-h-[800px]">
      <div className="text-center">
        <span className="bg-neutral-100 text-orange-500 rounded-full h-6 text-md font-bold px-2 py-1 uppercase">
          features
        </span>
